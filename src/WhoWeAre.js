             ...
             <br />
                 <div id="about" className="row">
                    ...
                    ~ Maya Angelou ~</center> </p>
                     ...
                     <br /> 
                        <h4 className="mb-4" id='malcolm'><center>The mother is the first teacher of the child. The message she gives that child, that child gives to the world.<br />~ Malcolm X ~</center></h4> <br /> <br /> <br /> <br /> <br /> <br />
                    </div>
