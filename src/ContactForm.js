...
//import { Card, ListGroup, ListGroupItem, Body } from 'bootstrap/dist/css/bootstrap.css'
...
export default function ContactForm() {
  ...
  <div className="card-body form">
    ...
    <p className="card-text">Our primary goals are 1) to transform justice systems so that they are driven by the  interests of youth and families, and 2) to move resources away from incarceration  based on failed “tough on crime” policies and towards direct investments in young  people, their families and the communities. The organization has relied on three  inter-related core strategies to achieve our goals.</p>
...
{/* 
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-10">
          <h3>Second column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-11">
          <h3>Third column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-12">
          <h3>Second column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-13">
          <h3>Third column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-14">
          <h3>Second column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-15">
          <h3>Third column</h3>
          <p>Normal content.</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="content1 colour-16">
          <h3>Third column</h3>
          <p>Normal content.</p>
        </div>
      </div>
...
//                                 <div className="card-body">
//                                     <h4 className="card-title">2 Card title</h4>
//                                     <p className="card-text">Justice for Families recognizes the need to hold elected and appointed officials  accountable for policies and practices that result in the exclusion of families and  the lock- up of far too many youth. Throughout our history, the staff and members  of J4F have supported numerous local, state and national campaigns by sharing  their experiences with the public and policy makers.</p>
//                                     <p className="card-text"><small Name="text-muted">Last updated 3 mins ago</small></p>
//                                 </div>
